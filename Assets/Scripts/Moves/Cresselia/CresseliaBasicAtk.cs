...
public class CresseliaBasicAtk : BasicAttackBase
{
    ...
    public override void Initialize(PlayerManager manager)
    {
        ...
        normalDmg = new DamageInfo(playerManager.NetworkObjectId, 1f, 0, 0, DamageType.Physical);
        boostedDmg = new DamageInfo(playerManager.NetworkObjectId, 0.44f, 18, 280, DamageType.Special);
